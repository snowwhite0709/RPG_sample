...
class FieldMapWithImages extends JPanel {
	...
	class ArrowKeyListener implements KeyListener {
		...
		public void keyPressed(KeyEvent e) {
			System.out.println("keyListener");
	         ...
	         switch( keyCode ) {
	         case KeyEvent.VK_LEFT: gX--; break;
	         case KeyEvent.VK_RIGHT: gX++; break;
	         case KeyEvent.VK_UP: gY--; break;
	         case KeyEvent.VK_DOWN: gY++; break;
	         }
	...
	public FieldMapWithImages() {
		...
		setFocusable(true); // フォーカスを設定
		requestFocus(); // フォーカスを要求
